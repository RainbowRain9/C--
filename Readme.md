...
- 形象记忆法
    ...
    1. 手里已经有一些排好序的牌（已排序区域）
    2. 从牌堆抽一张新牌（temp = a[i]）
    3. 从右往左看手牌（j = i-1开始）
    4. 比新牌大的都往右移（while循环）
    5. 找到合适的位置插入新牌（a[j+1] = temp）
...
- 原理
    ...
    堆排序是一种基于完全二叉树的排序算法。它首先将数组构建成一个最大堆(父节点值大于子节点值),然后每次将堆顶元素(最大值)与末尾元素交换,并重新调整堆结构,直到所有元素排序完成。

    主要步骤:
    1. 构建最大堆:从最后一个非叶子节点开始,自下而上调整每个节点,使其满足堆的性质
    2. 排序过程:
    - 将堆顶元素(最大值)与末尾元素交换
    - 将堆的大小减1
    - 从堆顶开始向下调整,重新构建最大堆
    ...
    时间复杂度为O(nlogn),空间复杂度为O(1)。堆排序的主要优点是数据移动次数少。
...
- 例题
  - [242-有效的字母异位词](./Algorithm/LeetCode/All/242-有效的字母异位词.cpp)
...
- 例题
  - [49-字母异位词分组](./Algorithm/LeetCode/All/49-字母异位词分组.cpp)
...
- 例题
  - [1047-删除字符串中的所有相邻重复项](./Algorithm/LeetCode/All/1047-删除字符串中的所有相邻重复项.cpp)
...
- 定长滑动窗口的题目
  - [643-子数组最大平均数I](./Algorithm/LeetCode/灵茶山艾府/01-滑动窗口与双指针/01-定长滑动窗口/643-子数组最大平均数I.cpp)
  - [1052-爱生气的书店老板](./Algorithm/LeetCode/灵茶山艾府/01-滑动窗口与双指针/01-定长滑动窗口/1052-爱生气的书店老板.cpp)
...
- 题目
  - [3-无重复字符的最长子串](./Algorithm/LeetCode/灵茶山艾府/01-滑动窗口与双指针/02-不定长滑动窗口/2.1-求最长或最大/03-无重复字符的最长子串.cpp)
...
- 题目
  - [11-盛最多水的容器](./Algorithm/LeetCode/灵茶山艾府/01-滑动窗口与双指针/03-单序列双指针/11-盛最多水的容器.cpp)
...
- 题目
  - [27-移除元素](./Algorithm/LeetCode/灵茶山艾府/01-滑动窗口与双指针/03-单序列双指针/27-移除元素.cpp)
